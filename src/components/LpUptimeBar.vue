      ...
      <div class="flex h-7 items-stretch gap-0.5">
        <TooltipRoot v-for="(seg, i) in segments" :key="i">
          <TooltipTrigger as-child>
            <button
              type="button"
              class="min-w-0 flex-1 rounded-xs outline-none transition-[scale,opacity] duration-150 hover:scale-y-110 focus-visible:ring-2 focus-visible:ring-ring focus-visible:shadow-[var(--glow-brand)]"
