    ...
    <div v-for="(section, si) in groups" :key="si" class="flex flex-col gap-0.5">
      ...
      >
        <component
          ...
          class="group/item relative flex items-center gap-3 rounded-control px-3 py-2 text-sm font-medium outline-none transition-colors duration-[var(--duration-fast)] focus-visible:ring-2 focus-visible:ring-ring focus-visible:shadow-[var(--glow-brand)]"
          :class="item.disabled
