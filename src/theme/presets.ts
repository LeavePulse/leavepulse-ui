...
export const dark: TokenSet = {
  ...
  colors: {
    ...
    action: "#39e58c",
    actionHover: "#4dffa1",
    actionSoft: "rgba(57, 229, 140, 0.14)",
    accent: "#f0b35a",
    accentHover: "#f2bf74",
    accentSoft: "rgba(240, 179, 90, 0.14)",
    danger: "#ff6f6f",
    dangerHover: "#ff8585",
...
export const light: TokenSet = {
  ...
  colors: {
    ...
    action: "#1f9d5f",
    actionHover: "#23b06b",
    actionSoft: "rgba(31, 157, 95, 0.12)",
    accent: "#aa6f1d",
    accentHover: "#b88641",
    accentSoft: "rgba(170, 111, 29, 0.12)",
    danger: "#c2333b",
    dangerHover: "#d23b44",
...
export const lime: TokenSet = {
  ...
  colors: {
    ...
    action: "#5fd97a",
    actionHover: "#74e88d",
    actionSoft: "rgba(95, 217, 122, 0.14)",
    accent: "#ffb84d",
    accentHover: "#ffc369",
    accentSoft: "rgba(255, 184, 77, 0.14)",
    danger: "#ff6f6f",
    dangerHover: "#ff8585",
    dangerSoft: "rgba(255, 111, 111, 0.14)",
...
export const leavepulse: TokenSet = {
  ...
  colors: {
    ...
    action: "#44c2ad",
    actionHover: "#56d3be",
    actionSoft: "rgba(68, 194, 173, 0.14)",
    accent: "#d36a2c",
    accentHover: "#da824e",
    accentSoft: "rgba(211, 106, 44, 0.14)",
    danger: "#f87171",
    dangerHover: "#fca5a5",
...
export const rose: TokenSet = {
  ...
  colors: {
    ...
    action: "#34d399",
    actionHover: "#4adeaa",
    actionSoft: "rgba(52, 211, 153, 0.14)",
    accent: "#fbbf24",
    accentHover: "#fcc947",
...
export const amber: TokenSet = {
  ...
  colors: {
    ...
    action: "#4ade80",
    actionHover: "#5cea90",
    actionSoft: "rgba(74, 222, 128, 0.14)",
    accent: "#38bdf8",
    accentHover: "#58c8f9",
...
export const nord: TokenSet = {
  ...
  colors: {
    ...
    action: "#a3be8c",
    actionHover: "#b3cb9f",
    actionSoft: "rgba(163, 190, 140, 0.16)",
    accent: "#ebcb8b",
    accentHover: "#eed39e",
    accentSoft: "rgba(235, 203, 139, 0.16)",
    danger: "#bf616a",
    dangerHover: "#cb727b",
